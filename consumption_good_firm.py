...
Class for ConsumptionGoodFirm agents, based on the MESA Agent class.
This class contains the intialization of consumption good firms and all stages
...
class ConsumptionGoodFirm(Agent):
    """Class representing a consumption good firm. """
    ...
    def __init__(self, model, prod, wage, price, market_share, sales=10,
        ...
        """Initialization of a ConsumptionGoodFirm agent.
        ...
        # self.market_share = [market_share, market_share, market_share]
    ...
    def market_share_calculation(self):
        ...
        avg_comp = gov.avg_norm_comp["Cons"]
    ...
    def price_demand_normalized(self):
        ...
        """
        gov = self.model.governments[0]
        price = gov.norm_price_unf_dem[self.unique_id]
    ...
    def market_share_normalized(self):
        ...
        gov = self.model.governments[0]
        market_share = gov.norm_market_shares[self.unique_id]
    ...
    # ------------------------------------------------------------------------
    #             CONSUMPTIONGOODFIRM STAGES FOR STAGED ACTIVATION
    # ------------------------------------------------------------------------
    def stage0(self):
        """Stage 0:
